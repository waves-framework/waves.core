...
using Fluid.Core.Logging.Core.Sinks;
...
namespace Fluid.Core.Logging.Configuration
{
    ...
    public class LoggerSinkConfiguration
    {
        ...
        private readonly Action<LoggerConfiguration> _applyInheritedConfiguration;
            ...
            Action<LoggerConfiguration> applyInheritedConfiguration)
        {
            ...
            _applyInheritedConfiguration = applyInheritedConfiguration ??
                                           throw new ArgumentNullException(nameof(applyInheritedConfiguration));
        }
            ...
            LoggingLevelSwitch levelSwitch = null)
        {
            ...
            if (levelSwitch != null)
            {
                if (restrictedToMinimumLevel != LevelAlias.Minimum)
                    SelfLog.WriteLine(
                        "Sink {0} was configured with both a level switch and minimum level '{1}'; the minimum level will be ignored and the switch level used",
                        sink, restrictedToMinimumLevel);
            ...
            LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum)
        {
            ...
            var secondarySink = new SecondaryLoggerSink(logger);
        ...
        /// <returns>Configuration object allowing method chaining.</returns>
        public LoggerConfiguration Conditional(Func<LogEvent, bool> condition,
        ...
        /// <returns>Configuration object allowing method chaining.</returns>
        [Obsolete(
            "Please use `LoggerConfiguration.Wrap(loggerSinkConfiguration, wrapSink, configureWrappedSink, restrictedToMinimumLevel, levelSwitch)` instead.")]
            ...
            LoggingLevelSwitch levelSwitch)
        {
            ...
            var enclosed = sinksToWrap.Count == 1 ? sinksToWrap.Single() : new SafeAggregateSink(sinksToWrap);
