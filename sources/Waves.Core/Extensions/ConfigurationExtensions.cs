...
internal static class ConfigurationExtensions
{
    ...
    internal static void SaveConfiguration(this IWavesConfiguration configuration, string path, string fileName)
    {
        if (path == null)
        {
    ...
    internal static WavesConfiguration LoadConfiguration(string path, string fileName)
    {
        if (path == null)
        {
            throw new ArgumentNullException(nameof(path));
